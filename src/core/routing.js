...
const exportCapabilities = new Map(
  [
    ...
    ["qoderwork:codex", { format: "codex-session", resumable: true }],
    ["qoderwork:claude", { format: "claude-session", resumable: true }],
    ["qoderwork:qodercli", { format: "qoder-session", resumable: true }],
