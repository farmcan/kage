...
const copy = {
  "zh-CN": {
    ...
    more: {
      label: "不只会转换",
      heading: "所有本地会话，一个入口。",
      description: "搜索、浏览、分身、跨 Agent 接力、HTML 回放（x2v / c2v / q2v）、导出清理（kage clean）和手机调度，都在一套本地 CLI 里；QoderWork 也能作为搜索、回放和接力来源。",
      commands: [
        ...
        { command: "kage serve --password 1234", title: "手机查看和调度 Agent", text: "在可信局域网观察进度，并按需启动新的本地任务。" },
      ],
      monitorTitle: "从手机看进度，也能启动新任务",
      monitorText: "通过可信局域网操作本机 Agent；会话内容仍留在你的机器上。",
    },
    cta: {
  ...
  en: {
    ...
    more: {
      ...
      description: "Search, browse, clone, bridge, replay to local HTML (x2v / c2v / q2v), clean exports (kage clean), and dispatch from your phone through one local CLI. QoderWork is also available as a search, replay, and bridge source.",
      commands: [
        ...
        { command: "kage serve --password 1234", title: "Monitor and dispatch from your phone", text: "Watch progress and start new local tasks over a trusted LAN." },
      ],
      monitorTitle: "Watch progress and start new tasks from your phone",
      monitorText: "Operate local agents over a trusted LAN — session content stays on your machine.",
    },
    cta: {
